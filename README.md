...
***🧠 How It Works
Capture video input using OpenCV.
Detect helmet presence using YOLOv8.
Extract number plate using EasyOCR.
Log the data into MongoDB.
Generate PDF challan and send it via Email and SMS.
=======
